...
int main()
{
    ...
    float complex alpha = 1.1 + 2.2*I;
    float complex beta =  2.0 + 1.2*I;
    float complex A[6] = {1.0 + 1.0*I, 2.0 + 2.0*I, 3.0+ 3.0*I, 4.0+4.0*I, 5.0+5.0*I, 6.0+6.0*I}; // Matrix A (stored in row-major order)
    int lda = 2;                                  // Leading dimension of A (number of columns)
    float complex x[3] = {3.0+3.0*I, 2.0+2.0*I, 4.0+4.0*I};                // Vector x
    int incx = 1;                                 // Increment for x (stride between elements)
    int incy = 1;
    float complex y[2] = {0.0+1.0*I, 1.0+2.0*I};                     // Result vector y
...
/*
y[0] = (-128.800003, 65.800003)
y[1] = (-167.600006, 88.800003)
*/